...
* Finding keywords
    ...
    * Image Logo is https://hackyholidays.h1ctf.com/assets/images/grinch-networks.png. `grinch-networks` is how they call(from logo's name). We should search `grinch-networks` 
    * https://storage.googleapis.com/[grinch-networks/grinchnetworks]
    ...
* Use following resources to search these keywords
    * GitHub
