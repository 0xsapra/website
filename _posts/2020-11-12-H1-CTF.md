...
[solver-h1-ctf-flag-9.py](/assets/files/h1-ctf-flag-9.py) is the python script to automate the complete sql-injection and leak the admin credentials. It has detailed comments about every step of attack.
