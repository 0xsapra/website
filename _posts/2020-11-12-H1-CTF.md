...
[solver-h1-ctf-flag-9.py](/assets/files/h1-ctf-flag-9.py) is the python script to automate the sql-injection. It has detailed comments and perform the complete injection and leak all the information from the database.
